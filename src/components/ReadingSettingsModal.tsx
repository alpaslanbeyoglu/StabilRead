...
import { FontFamily, ReadingTheme, StabilizationConfig, TypographySettings } from '../types';
import { AlignLeft, Sliders, Type, X, Eye, Sparkles } from 'lucide-react';
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-slate-950/50">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-base font-bold text-white font-['Plus_Jakarta_Sans']">
              Okuyucu ve Stabilizasyon Ayarları
            </h2>
          </div>
          <button
            onClick={onClose}
